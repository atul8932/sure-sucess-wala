  ...
  return (
    <div className="page-container">
      ...
      <main>
        <section className="content-hero">
          <motion.h1 initial={{ y: 18, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="content-title">
            Terms & Conditions — Sure Success Wala
          </motion.h1>
          <motion.p initial={{ y: 18, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="content-sub">
            These Terms govern your use of Sure Success Wala services and website. Read carefully before using the site.
          </motion.p>
        </section>

        <section className="section-block">
          <div className="section-heading">1. Acceptance</div>
          <div className="long-article">
            <p>By accessing or using our site, you agree to be bound by these Terms. If you disagree, please do not use the site.</p>
          </div>
        </section>

        <section className="section-block">
          <div className="section-heading">2. Account & Usage</div>
          <div className="long-article">
            <p>You are responsible for maintaining the confidentiality of your account information and for any activities under your account.</p>
          </div>
        </section>

        <section className="section-block">
          <div className="section-heading">3. Payments & Refunds</div>
          <div className="long-article">
            <p>Paid courses are processed via secure gateways. Refund policy: replace with your own policy text here.</p>
          </div>
        </section>

        <section className="section-block">
          <div className="section-heading">4. Intellectual Property</div>
          <div className="long-article">
            <p>All course content, PDFs and videos are intellectual property of Sure Success Wala or its licensors. Do not redistribute without permission.</p>
          </div>
        </section>

        <section className="section-block">
          <div className="section-heading">5. Limitation of Liability</div>
          <div className="long-article">
            <p>Use of content is at your own risk. We are not liable for exam outcomes; we provide guidance and materials to help preparation.</p>
          </div>
        </section>
      </main>
      ...
      <style>{`
        ...
        .section-heading { font-size:20px; font-weight:700; color:#e6eef8; margin-bottom:12px; }
